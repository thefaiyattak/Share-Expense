...
export const defaultTutorialsList = [
  {
    id: 'def_1',
    title: '01. Understand Your Dashboard',
    description: 'See balances, manage private lending, and record daily entries from one screen. Switch teams, open tutorials, check personal & collective wallet balances, manage Money Circle, and add daily category breakdown entries.',
    imageSource: require('../../assets/tutorials/01_understand_your_dashboard.png'),
    isDefault: true,
  },
  {
    id: 'def_2',
    title: '02. Switch Between Groups',
    description: 'Move between personal and team workspaces, or create and join a new group. Select workspaces, verify your role (Personal, Admin, or Member), create a group, or join with an invite code.',
    imageSource: require('../../assets/tutorials/02_switch_between_groups.png'),
    isDefault: true,
  },
  {
    id: 'def_3',
    title: '03. Update Your Wallet',
    description: 'Add or subtract funds and set an optional monthly spending target. Choose Add or Subtract action, enter the amount, set a target, and save the update.',
    imageSource: require('../../assets/tutorials/03_update_your_wallet.png'),
    isDefault: true,
  },
  {
    id: 'def_4',
    title: '04. Add a Breakfast Expense',
    description: 'Enter purchase details, choose who shared it, and save the expense. Confirm target date, enter item details (name, quantity, price), attach receipts, add multiple items, and select splitting members.',
    imageSource: require('../../assets/tutorials/04_add_a_breakfast_expense.png'),
    isDefault: true,
  },
  {
    id: 'def_5',
    title: '05. Use Money Circle',
    description: 'Track private one-to-one lending, borrowing, and personal balances. Review net circle balance (To Collect / To Pay), record Lent (Give) money, record Borrow (Take) money, and filter transaction history.',
    imageSource: require('../../assets/tutorials/05_use_money_circle.png'),
    isDefault: true,
  },
  {
    id: 'def_6',
    title: '06. Manage Notifications',
    description: 'Review wallet and expense activity, open details, or manage alerts. Read activity timestamps, check WALLET vs EXPENSE type badges, and tap Open to inspect related actions.',
    imageSource: require('../../assets/tutorials/06_manage_notifications.png'),
    isDefault: true,
  },
  {
    id: 'def_7',
    title: '07. Review Shared Expenses',
    description: 'Compare totals, inspect each member\'s share, and prepare settlement reports. Choose period or check History, review collective deposits & left amount, inspect donut spending distribution, and open Settlement Plan or export PDF/CSV.',
    imageSource: require('../../assets/tutorials/07_review_shared_expenses.png'),
    isDefault: true,
  },
  {
    id: 'def_8',
    title: '08. Review Member Details',
    description: 'Check a member\'s monthly balance, spending breakdown, and expense history. Choose month, understand deposits vs out-of-pocket payments vs fair share and net balance, inspect category breakdown & wallet usage gauge, and review individual entries.',
    imageSource: require('../../assets/tutorials/08_review_member_details.png'),
    isDefault: true,
  },
  {
    id: 'def_9',
    title: '09. Review the Settlement Plan',
    description: 'Choose a settlement method, verify each member\'s balance, and share the plan. Check collected pool vs group spent, inspect member refund/owes breakdown, and share directly via WhatsApp.',
    imageSource: require('../../assets/tutorials/09_review_the_settlement_plan.png'),
    isDefault: true,
  },
  {
    id: 'def_10',
    title: '10. Use Direct Peer-to-Peer',
    description: 'Follow optimized transfers to settle member balances with minimum payments. Review total group spending and optimized single transfers directly between teammates, then share plan to WhatsApp or finish.',
    imageSource: require('../../assets/tutorials/10_use_direct_peer_to_peer.png'),
    isDefault: true,
  },
  {
    id: 'def_11',
    title: '11. Analyze Spending Statistics',
    description: 'Compare time ranges and explore where your team\'s money was spent. Choose Daily, Weekly, Monthly, or Custom, check total amount and count, compare categories, and inspect interactive donut segment breakdowns.',
    imageSource: require('../../assets/tutorials/11_analyze_spending_statistics.png'),
    isDefault: true,
  },
  {
    id: 'def_12',
    title: '12. Explore Detailed Statistics',
    description: 'Inspect daily category activity and compare spending across members. Follow color-coded category legends, tap any day on the trend line graph to reveal daily totals, and review member spending percentage progress bars.',
    imageSource: require('../../assets/tutorials/12_explore_detailed_statistics.png'),
    isDefault: true,
  },
  {
    id: 'def_13',
    title: '13. Configure Your Settings',
    description: 'Manage your profile, preferences, security, guides, and account access. Edit profile info & bio, manage groups, change currency, toggle Dark Mode, manage notifications, reset password, and access tutorials.',
    imageSource: require('../../assets/tutorials/13_configure_your_settings.png'),
    isDefault: true,
  },
];
